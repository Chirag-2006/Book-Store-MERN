    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:5555/books/${id}`)
            .then((res) => {
                ...
                setLoading(false)
                alert("An error occurred while fetching the book please cheak the console")
    ...
    return (
        <div className='p-4'>
            ...
            <div className="flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto">
                ...
                <button className='bg-green-500 text-white p-2 m-8 rounded-lg w-full mx-auto hover:bg-green-600' onClick={handleEditBook}>Save Book
